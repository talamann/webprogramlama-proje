    ...
    public class TeacherController : Controller
    {
            ...
            DateTime dueDate, int maxGrade = 100)
        {
            try
            {
                ...
                if (!students.Any())
                {
                    TempData["Error"] = "Sistemde kay�tl� ��renci bulunmamaktad�r.";
                ...
                TempData["Success"] = $"�dev ba�ar�yla olu�turuldu ve {students.Count()} ��renciye atand�.";
                return RedirectToAction("Index");
            }
            catch (Exception ex)
            {
                TempData["Error"] = $"�dev olu�turulurken bir hata olu�tu: {ex.Message}";
                return RedirectToAction("CreateAssignment");
            }
        }
